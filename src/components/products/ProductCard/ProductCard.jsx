...
const ProductCard = ({ card }) => {
  const { deleteProduct, likeProduct, getOneProduct, setLikeStorage, oneProduct} = useProducts();
          ...
          {auth && (
            <div>
              ...
              <Menu
                ...
                onClose={handleClose}
              >
                <MenuItem onClick={() => navigate(`/edit/${card.id}`)}>Edit</MenuItem>
                <MenuItem onClick={() => deleteProduct(card.id)}>Detete</MenuItem>
                <MenuItem onClick={() => navigate(`/details/${card.id}`)}>Details</MenuItem>
              </Menu>
            </div>
          )}
        </Toolbar>
